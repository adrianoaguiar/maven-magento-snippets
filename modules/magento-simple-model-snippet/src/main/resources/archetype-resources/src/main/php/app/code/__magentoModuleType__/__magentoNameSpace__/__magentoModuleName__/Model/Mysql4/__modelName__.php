<?php
class ${magentoNameSpace}_${magentoModuleName}_Model_Mysql4_${modelName} extends Mage_Core_Model_Mysql4_Abstract
{
	protected function _construct()
	{
		$this->_init('${magentoModuleNameLowerCase}/${modelNameLowerCamel}', 'entity_id');
	}
	...
	public function myResourceMethod() {
		...
		$sql = sprintf('SELECT * FROM %s', $this->getTable('${magentoModuleNameLowerCase}/${modelNameLowerCamel}'));
		...
		$select->from( array('table_alias' => $this->getTable('${magentoModuleNameLowerCase}/${modelNameLowerCamel}')), array('text_field', 'float_field') );
		 
		// join table as table_alias2 using key_field
		/*$select->join(array('table_alias2' => $this->getTable('${magentoModuleNameLowerCase}/${modelNameLowerCamel}')),
		...
		*/
		...
		/*$select->join(array('table_alias3' => $this->getTable('${magentoModuleNameLowerCase}/${modelNameLowerCamel}')),
